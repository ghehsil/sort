...
public class hashTable {
    ...
    public static void main(String[] args) {
        LRUBaseHashTable<Integer, String> lruBaseHashTable = new LRUBaseHashTable<>();
        lruBaseHashTable.add(1, "a");
        lruBaseHashTable.add(1, "d");
        lruBaseHashTable.add(2, "b");
        lruBaseHashTable.add(3, "c");

        lruBaseHashTable.printAll();
        System.out.println(lruBaseHashTable.get(1));
        lruBaseHashTable.printAll();
        System.out.println(lruBaseHashTable.get(2));
        lruBaseHashTable.printAll();
    }

}

class LRUBaseHashTable<K, V> {
