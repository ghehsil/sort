...
public class AnnotationTest {
    ...
    public void test(@MyAnTargetParameter("String") String args1,
                     @MyAnTargetParameter("Integer") Integer args2,
                     @MyAnTargetParameter("Boolean") Boolean args3) {
        System.out.println("参数值 === " + args1 + args2 + args3);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            method.invoke(annotationTest, "A", 1, true);
